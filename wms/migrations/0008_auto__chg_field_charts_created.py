...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Charts.created'
        db.alter_column('wms_charts', 'created', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Charts.created'
        db.alter_column('wms_charts', 'created', self.gf('django.db.models.fields.DateTimeField')())
