...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChartType.interval'
        db.add_column('wms_charttype', 'interval',
                      self.gf('django.db.models.fields.CharField')(default='days', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ChartType.interval'
        db.delete_column('wms_charttype', 'interval')
